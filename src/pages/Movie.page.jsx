            ...
            <div className="my-12 container px-4 lg:ml-20 lg:w-2/3">
                <div className="flex flex-col items-start gap-3">
                    ...
                    <p>
                        ...
                        together after the death of Clark Kent. Meanwhile, Darkseid sends Steppenwolf to Earth with an army to subjugate humans.
                    </p>
                </div>
                <div className="my-8">
                    <hr />
                    ...
                    <div className="flex flex-col gap-3 lg:flex-row">
                        <div className="flex items-start gap-2 bg-yellow-100 p-3 border-yellow-400 border-dashed border-2 rounded-md">
                            ...
                            <div className="flex flex-col items-start ">
                                <h3 className="text-gray-600 text-xl font-bold">Visa Stream Offer</h3>
                        ...
                        <div className="flex items-start gap-2 bg-yellow-100 p-3 border-yellow-400 border-dashed border-2 rounded-md">
                            ...
                            <div className="flex flex-col items-start ">
                                <h3 className="text-gray-600 text-xl font-bold">Filmy Pass</h3>
                                <p className="text-gray-600">
